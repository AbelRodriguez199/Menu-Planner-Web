...
<div className="row justify-content-center  d-flex text-center mt-5">
					<div className="col-md-4 col-feature">
						<div className="m-shadow-32 btn-primary bgd-gradient-light-blue rounded-circle justify-center border border-secondary d-inline-block p-4 mb-4">
							<i className="fa fa-4x fa-bullseye " aria-hidden="true"></i>
						</div>
						<h4>Categorías</h4>
					...
					<div className="col-md-4 col-feature">
						<div className="m-shadow-32 btn-success bgd-gradient-blue rounded-circle justify-center border border-secondary d-inline-block p-4 mb-4">
							<em className="fa fa-4x fa-cutlery "></em>
						</div>
						<h4>Menú Semanal</h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse cursus erat sed sem sagittis cursus.</p>
					...
					<div className="col-md-4 col-feature">
						<div className=" m-shadow-32 btn-secondary	bgd-gradient-light-blue rounded-circle justify-center border border-secondary d-inline-block p-4 mb-4">
							<em className="fa fa-4x fa-list-alt"></em>
						</div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-6 col-sm-3">
            ...
            <div class="col-xs-6 col-sm-3">
                <h4 class="my-2">Síguenos</h4>
                <ul class="list-unstyled list-light">
                  <li><i class="fa fa-facebook btn-primary text-light" aria-hidden="true"></i><a href="https://www.facebook.com/"> Facebook</a></li>
                  <li><i class="fa fa-twitter btn-light text-primary" aria-hidden="true"></i><a href="https://twitter.com/?lang=es"> Twitter</a></li>
                  <li><i class="fa fa-instagram btn-danger text-light" aria-hidden="true"></i><a href="https://www.instagram.com/?hl=es"> Instagram</a></li>
                </ul>
                <p class="color-light mt-2">Novedades!</p>
                <form>
                  <div class="form-group">
                    <div class="input-group">
                      <input type="email" class="form-control form-control-sm" name="email" placeholder="Tu Email"/>
        ...
        <div class="row f-flex justify-content-between" >
          <div class="col-md-8 text-xs-center  text-left text-secondary my-1">
            <p class="mt-2  text-light"> © Copyright 2019 • Todos los Derechos Reservados |  <small class=" " href="#">Contacto</small></p>
          </div>
